...
public class QuanLyNhanVien extends javax.swing.JPanel {
    ...
    private void btnXuatFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatFileActionPerformed
        try{
            ...
            row.createCell(3).setCellValue(nv.getGioitinh()==1?"Nam":"Nữ");
            row.createCell(4).setCellValue(nv.getCMND());
            ...
            row.createCell(8).setCellValue(nv.getSongaylam());
            row.createCell(9).setCellValue(nv.getMaPB());
            }
            
            FileOutputStream out = new FileOutputStream(new File("D:/DanhSachNhanVien.xlsx"));
            workbook.write(out);
            out.close();
            }catch(Exception e){
            e.printStackTrace();
            }
       ThongBao.showThongBao(parentForm, "Xuất file thành công", "Thông báo");
